...
# Retrieve list of users worked by kca101
@get('/users')
def get_user_route():
   
    print "Retrieving user \n"

    return retrieve_ops.retrieve_list_users(table,response)
...
def delete_activity_route(id, activity):
    ...
    return delete_ops.delete_activity(table, id, activity, response)
